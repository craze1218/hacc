...
export const HtmlIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2 3 4.5v11L12 18l9-2.5v-11L12 2z"/></svg>
);

export const CssIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="m12 2-9 2.5v11l9 2.5 9-2.5v-11z"/><path d="M17.5 15H15l-2.5-3 2.5-3h2.5"/><path d="M9.5 15H7l-2.5-3 2.5-3h2.5"/>
    </svg>
);
...
export const PythonIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M10.8 17.2c-2.4-1-3.4-3.8-2.6-6.3l4.6-1.5c.9-.3 1.8.3 2.1 1.2c.4 1.1.2 2.3-.6 3.1l-2.4 2.4c-1.4 1.4-3.6 1.5-5.1.1z"></path>
    <path d="M13.2 6.8c2.4 1 3.4 3.8 2.6 6.3l-4.6 1.5c-.9.3-1.8-.3-2.1-1.2c-.4-1.1-.2-2.3.6-3.1l2.4-2.4c1.4-1.4 3.6-1.5 5.1-.1z"></path>
  </svg>
);
